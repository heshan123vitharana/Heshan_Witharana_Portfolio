    ...
    <section id="home" className="min-h-screen relative overflow-hidden flex items-center justify-center lg:items-end">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 pt-20 pb-20 lg:pb-0 flex flex-col lg:flex-row lg:items-center lg:justify-between items-center pointer-events-none">
        ...
        <div className="flex flex-col items-center lg:items-center lg:flex-1 lg:min-w-0 lg:px-8 pointer-events-auto">
          ...
          >
            <span className="text-3xl md:text-5xl lg:text-6xl gradient-text inline-block hero-name-glow">
              {firstName}
            </span>
            {lastName && (
              <span className="text-3xl md:text-5xl lg:text-6xl text-white inline-block ml-6 md:ml-10 hero-name-glow-white">
                {lastName}
              </span>
            )}
            <span className="typewriter-cursor text-3xl md:text-5xl lg:text-6xl" />
          </motion.h1>
