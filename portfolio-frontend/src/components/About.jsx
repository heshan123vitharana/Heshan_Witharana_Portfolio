...
const About = () => {
  ...
  return (
    <section id="about" className="py-20 bg-gradient-to-b from-dark-100/50 to-dark-100">
      <div className="container mx-auto px-4">
        ...
        >
          {features.map((feature) => (
            <motion.div
              ...
              className="bg-dark-200/40 p-6 rounded-lg border border-gray-700 hover:border-primary-500 transition-all duration-300 holographic"
              whileHover={{ scale: 1.05 }}
            >
              <div className="flex items-center justify-center w-16 h-16 bg-primary-500/20 rounded-lg mb-4 mx-auto">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="mt-16 bg-dark-200/40 p-8 rounded-lg border border-gray-700 scanner-line"
        >
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="relative">
              <div className="w-full h-64 bg-gradient-to-br from-primary-500/20 to-purple-500/20 rounded-lg flex items-center justify-center">
                <div className="text-center">
                  <div className="text-4xl font-orbitron font-bold text-white mb-2">5+</div>
                  <div className="text-primary-400">Years Experience</div>
                </div>
              </div>
            </div>
          </div>
